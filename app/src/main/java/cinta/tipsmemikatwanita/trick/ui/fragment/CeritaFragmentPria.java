package cinta.tipsmemikatwanita.trick.ui.fragment;
...
import cinta.tipsmemikatwanita.trick.base.BaseFragment;
import cinta.tipsmemikatwanita.trick.database.CacheDb;
import cinta.tipsmemikatwanita.trick.database.CeritaDb;
import cinta.tipsmemikatwanita.trick.model.Cerita;
import cinta.tipsmemikatwanita.trick.model.CeritaWrapper;
import cinta.tipsmemikatwanita.trick.ui.CeritaActivity;
import cinta.tipsmemikatwanita.trick.ui.Detail_Cerita_Activity;
import cinta.tipsmemikatwanita.trick.ui.adapter.CeritaAdapter;
import cinta.tipsmemikatwanita.trick.ui.adapter.CeritaAdapter3;
import cinta.tipsmemikatwanita.trick.ui.widget.LoadingLayout;
import cinta.tipsmemikatwanita.trick.ui.widget.PageIndicator;
import cinta.tipsmemikatwanita.trick.util.Debug;
import cinta.tipsmemikatwanita.trick.util.Util;
import cinta.tipsmemikatwanita.trick.volley.VolleyParsing;
import it.sephiroth.android.library.widget.HListView;

/**
 * Created by Toshiba Asywalul Fikri on 3/12/2016.
 */
public class CeritaFragmentPria extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {

    private int[] mResource = {R.drawable.pria, R.drawable.wanita, R.drawable.wanitadua};
    private String[] mResourceTitle = {"UNGKAPKAN CINTA", "PENGERTIAN", "PENGERTIAN"};
    ...
    public static CeritaFragmentPria newInstance() {
        return new CeritaFragmentPria();
    }
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        btnCeritarakyat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), CeritaActivity.class);
                intent.putExtra("type","stepempat");
                intent.putExtra("person","pria");
                startActivity(intent);
            }
        });
        ...
        mAdapter.moreCerita(new CeritaAdapter.MoreCerita() {
            ...
            public void OnMoreClickCerita(final  View view, final  int position) {
                ...
                if (ceritaDb.exist(cerita.id)) {
                    ...
                    ceritaDb.update(cerita,"bookmark-"+cerita.type+"-pria");
    ...
    public void loadTask() {
        startCountTime();
        String url = "http://wisatasumbar.esy.es/restful/memikatwanita.php?&type=populer&person=pria"+"&page="+page+"&count=15";
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList(wrapper);
                                    mCacheDb.update(wrapper.list,"populer-pria");
                                }
                            } else {
    ...
    public void loadTask2() {
        startCountTime();
        String url = "http://wisatasumbar.esy.es/restful/memikatwanita.php?&person=pria&page="+page +"&count=15";
        Log.d("urlnya", url);
        StringRequest mRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList2(wrapper);
                                    mCacheDb.update(wrapper.list,"terbaru-pria");
                                }
                            } else {
                                showEmpty(getString(R.string.text_download_failed));
                            }
    ...
    public class LoadCacheTask extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                ...
                wrapper = mCacheDb.getListCerita("populer-pria");
    ...
    public class LoadCacheTask2 extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                //Debug.i("Checking cache " + "home-" + mConvObject);
                wrapper = mCacheDb.getListCerita("terbaru-pria");
                Log.d("isinya",String.valueOf(wrapper));
                result 	= 1;
            } catch (Exception e) {
                e.printStackTrace();
