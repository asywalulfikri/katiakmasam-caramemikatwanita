...
public class CeritaFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private int[] mResource = {R.drawable.wanitasatu, R.drawable.wanita, R.drawable.wanitadua};
        ...
        mAdapter.moreCerita(new CeritaAdapter.MoreCerita() {
            ...
            public void OnMoreClickCerita(final  View view, final  int position) {
                ...
                if (ceritaDb.exist(cerita.id)) {
                    ...
                    ceritaDb.update(cerita,"bookmark-"+cerita.type+"-wanita");
    ...
    public void loadTask() {
        startCountTime();
        String url = "http://wisatasumbar.esy.es/restful/memikatwanita.php?&type=populer&person=wanita"+"&page="+page+"&count=15";
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList(wrapper);
                                    mCacheDb.update(wrapper.list,"populer-wanita");
                                }
                            } else {
    ...
    public void loadTask2() {
        startCountTime();
        String url = "http://wisatasumbar.esy.es/restful/memikatwanita.php?&person=wanita&page="+page +"&count=15";
        Log.d("urlnya", url);
        StringRequest mRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    @Override
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList2(wrapper);
                                    mCacheDb.update(wrapper.list,"terbaru-wanita");
                                }
                            } else {
                                showEmpty(getString(R.string.text_download_failed));
                            }
    ...
    public class LoadCacheTask extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                ...
                wrapper = mCacheDb.getListCerita("populer-wanita");
    ...
    public class LoadCacheTask2 extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                //Debug.i("Checking cache " + "home-" + mConvObject);
                wrapper = mCacheDb.getListCerita("terbaru-wanita");
                Log.d("isinya",String.valueOf(wrapper));
                result 	= 1;
            } catch (Exception e) {
                e.printStackTrace();
