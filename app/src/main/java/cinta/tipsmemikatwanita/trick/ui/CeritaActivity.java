...
import cinta.tipsmemikatwanita.trick.ui.adapter.CeritaAdapter2;
import cinta.tipsmemikatwanita.trick.ui.widget.ExpandableHeightListView;
...
public class CeritaActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    public void loadTask() {
        ...
        if(type.equals("terbaru")){
            url = "http://wisatasumbar.esy.es/restful/memikatwanita.php?&person="+person+"&page="+page+"&count=20";
        }else{
            url = "http://wisatasumbar.esy.es/restful/memikatwanita.php?&person="+person+"&type="+type+"&page="+page+"&count=20";
        }
        Log.d("urlnya", url);
                        ...
                        try {
                            ...
                            if (wrapper != null) {
                                if (wrapper.list.size() == 0) {
                                    ...
                                    updateList(wrapper);
                                    mCacheDb.update(wrapper.list,type+"-"+person);
                                }
                            } else {
    ...
    public class LoadCacheTask extends AsyncTask<URL, Integer, Long> {
        ...
        protected Long doInBackground(URL... urls) {
            ...
            try {
                ...
                wrapper = mCacheDb.getListCerita(type+"-"+person);
