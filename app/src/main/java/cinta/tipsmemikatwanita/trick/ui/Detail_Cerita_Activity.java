...
import cinta.tipsmemikatwanita.trick.ui.adapter.CustomArrayAdapter;
...
public class Detail_Cerita_Activity extends BaseActivity {
    ...
    public  void updateview(){
        ...
        Picasso.with(this) //
                .load((mCerita.image.equals("")) ? null :mCerita.image) //
    ...
    public void bookmark(){
        ...
        if (ceritaDb.exist(mCerita.id)) {
            ...
            ceritaDb.update(mCerita,"bookmark-"+mCerita.type+"-"+mCerita.person);
