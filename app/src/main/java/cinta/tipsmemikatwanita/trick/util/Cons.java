package cinta.tipsmemikatwanita.trick.util;
...
public class Cons {
	...
	public static final String DBNAME = "memikatwanita.db";
	public static final String DBPATH = "/data/data/cinta.tipsmemikatwanita.trick/";
	public static final String APP_DIR = "/.cerita";
	public static final String IMAGE_DIR = APP_DIR + "/thumbs";

	public static final String PACKAGE_PREFIX = "cinta.tipsmemikatwanita.trick";
